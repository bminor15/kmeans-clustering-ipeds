...
[@huberty2005cluster; @nces2023groupings].
...
- K-Means has a long history as a baseline clustering method
  [@lloyd1982least; @forgy1965cluster; @jain2010data]
:::
...
## Modeling Results: Choosing k {.smaller}

::: incremental
- Elbow method shows a clear bend at four clusters.
- Silhouette score peaks around \(k = 4\).
- Returns diminish beyond four clusters.
- Four clusters balance fit and interpretability.
:::

## Modeling Results: Cluster Sizes {.smaller}

<div style="text-align:center;">
  <img src="figs/figure9_cluster_sizes.png"
       style="max-width:80%; max-height:55vh; object-fit:contain;">
</div>
...
<div style="text-align:center;">
  <img src="figs/figure10.png"
       style="max-width:78%; max-height:55vh; object-fit:contain;">
</div>
...
- Data-driven clustering surfaces patterns that are not obvious from
  traditional labels alone [@huberty2005cluster; @elam2016classification].
:::
...
- These clusters provide clearer institutional peer groups than legacy
  ...
  [@tair2022peer; @mohdtalib2023behavioral].
:::
