...
- Visualized cluster separation with PCA (interpretation only)

---

## Key Findings

- Four recurring institutional profiles showed up: lower-resourced open access, balanced mid-tier, high-resource/high-tuition, and low-tuition but strong-outcome institutions.
- Strong outcomes aren’t limited to high-spending institutions.
- A small and focused feature set still reveals real structure across the higher ed landscape.
...
git clone https://github.com/bminor15/kmeans-clustering-ipeds.git
cd kmeans-clustering-ipeds

Install required R packages:

```text
install.packages(c("tidyverse", "janitor", "gt", "cluster",
                   "corrr", "GGally", "patchwork", "here"))
```
...
```
The rendered HTML will appear in /docs/.
